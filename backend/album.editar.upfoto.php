...
try {
	...
	$sqlDownFirst = "UPDATE fotos SET orden = -1 WHERE idEntidad = $idAlbum and orden = $ordenAnterior";
	echo $sqlDownFirst."<br>";
	mysqli_query($mysqli, $sqlDownFirst);
	$sqlUpFoto = "UPDATE fotos SET orden = $ordenAnterior WHERE idEntidad = $idAlbum and orden = $orden";
	echo $sqlUpFoto."<br>";
